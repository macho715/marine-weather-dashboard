...
import { sendEmail, sendSlack, type ChannelResult } from "@/lib/server/notifier"
...
export async function GET(request: Request) {
  ...
  const briefing = briefingPayload?.briefing ?? `${vesselPayload.vessel.name} briefing unavailable.`
